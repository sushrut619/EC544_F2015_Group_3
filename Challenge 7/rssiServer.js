...
// });
  ...
  XBeeAPI.on("frame_object", function(frame) {
    if (frame.type == 144){
      ...
      console.log("Beacon ID: " + frame.data[1] + ", RSSI: " + (frame.data[0]) + " Turn : " +  (frame.data[2]));
      socket.emit('sensor', { raw: 'Beacon ID: ' + frame.data[1] + '    RSSI: ' + frame.data[0] + '   Distance: ' + calculatedistance(frame.data[0]).toFixed(2) + ' cm', region: region.toFixed(0) });
